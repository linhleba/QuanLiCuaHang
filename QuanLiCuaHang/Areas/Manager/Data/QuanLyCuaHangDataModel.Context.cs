...
public partial class QUANLYCUAHANGEntity : DbContext
{
    ...
    public virtual int CREATE_BCTONKHO(Nullable<int> thang, Nullable<int> nam, Nullable<int> maSanPham, Nullable<int> tonDau, Nullable<int> tonCuoi, Nullable<int> sLMuaVao, Nullable<int> sLBanRa)
    {
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("CREATE_BCTONKHO", thangParameter, namParameter, maSanPhamParameter, tonDauParameter, tonCuoiParameter, sLMuaVaoParameter, sLBanRaParameter);
    }


    public virtual ObjectResult<BCTONKHO> Fun_CreateBCTonKho(Nullable<int> thang, Nullable<int> nam, Nullable<int> maSanPham, Nullable<int> tonDau, Nullable<int> tonCuoi, Nullable<int> sLMuaVao, Nullable<int> sLBanRa)
    {
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<BCTONKHO>("Fun_CreateBCTonKho", thangParameter, namParameter, maSanPhamParameter, tonDauParameter, tonCuoiParameter, sLMuaVaoParameter, sLBanRaParameter);
    }


    public virtual ObjectResult<BCTONKHO> Fun_CreateBCTonKho(Nullable<int> thang, Nullable<int> nam, Nullable<int> maSanPham, Nullable<int> tonDau, Nullable<int> tonCuoi, Nullable<int> sLMuaVao, Nullable<int> sLBanRa, MergeOption mergeOption)
    {
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<BCTONKHO>("Fun_CreateBCTonKho", mergeOption, thangParameter, namParameter, maSanPhamParameter, tonDauParameter, tonCuoiParameter, sLMuaVaoParameter, sLBanRaParameter);
    }
